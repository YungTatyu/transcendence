...
urlpatterns = [
    ...
    path("notes/update/<int:id>/", views.NoteUpdateView.as_view(), name="note_update"),
    path("notes/delete/<int:id>/", views.NoteDestroyView.as_view(), name="note_delete"),
    path("users/", views.UserListView.as_view(), name="user_list"),
    path("users/create/", views.UserCreateView.as_view(), name="user_create"),
    path("users/delete/<int:id>/", views.UserDestroyView.as_view(), name="user_delete"),
