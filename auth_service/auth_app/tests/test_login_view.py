...
class OTPAuthTests(APITestCase):
    ...
    def test_login_invalid_password(self):
        ...
        self.assertIn("Invalid email or password.", response.data.get("error", []))

    def test_login_missing_fields(self):
        """
        ✅ emailまたはパスワードがない場合にエラー
        """
    ...
    def test_otp_verification_success(self):
        ...
        response = self.client.post(
            self.verify_url, {"email": self.email, "otp": otp_token}
        )
    ...
    def test_otp_verification_invalid_otp(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertIn("Invalid OTP.", response.data.get("error", []))
